 ...
 * create Apr 11, 2017
 */
public class Q100Piepme implements Serializable {
	...
	@QbMapping(name = "qv114", typeMapping = Types.CHAR)
	private String qv114;
	@QbMapping(name = "qv115", typeMapping = Types.CHAR)
	private String qv115;
	@QbMapping(name = "qd116", typeMapping = Types.DATE)
	private Date qd116; //han su dung chuc nang dang tin bat dong san
	...
	public String getQv114() {
		return qv114;
	}

	public void setQv114(String qv114) {
		this.qv114 = qv114;
	}

	public String getQv115() {
		return qv115;
	}

	public void setQv115(String qv115) {
		this.qv115 = qv115;
	}

	public Date getQd116() {
		return qd116;
	}

	public void setQd116(Date qd116) {
		this.qd116 = qd116;
	}

	@Override
	public String toString() {
		return "Q100Piepme [useApp=" + useApp + ", packet=" + packet
				...
				+ ", qv112=" + qv112 + ", qv114=" + qv114 + ", qv115=" + qv115
				+ ", qd116=" + qd116 + ", fc800=" + fc800 + ", fn100=" + fn100
				+ ", po100=" + po100 + ", ov101=" + ov101 + ", ov102=" + ov102
				+ ", ov103=" + ov103 + ", ov108=" + ov108 + ", nv116=" + nv116
				+ ", nv117=" + nv117 + ", nv118=" + nv118 + ", nv119=" + nv119
				+ ", nv120=" + nv120 + ", konto=" + konto + "]";
	}
}
