 ...
 * create Jul 29, 2017
 */
@Repository(value = SpringBeanNames.REPOSITORY_NAME_P300BEDUP)
@Scope("prototype")
public class P300BEduPMGDaoImpl extends QbMongoDaoSupport implements P300BEduPMGDao{

	@Override
	public List<Pieper> getListPieper(int fo100, int pnFT110, String pnTV119, String pvSearch, String pvSearchSteam, int pnOffset, int pnLimit) {
		// TODO Auto-generated method stub
		try {
			setFunctionName(QbMongoFunctionNames.P300B_LISTOFTABP300B_EDU);
			setParameterNumber(fo100);
			setParameterNumber(pnFT110);
			setParameterString(pnTV119);
			setParameterString(pvSearch);
			setParameterString(pvSearchSteam);
	...
	public P300BEduPMG getPieperDetail(int fo100, int pp100) {
		// TODO Auto-generated method stub
		try {
			setFunctionName(QbMongoFunctionNames.P300B_LISTOFTABP300B_DETAIL_EDU);
			setParameterNumber(fo100);
			setParameterNumber(pp100);
			String kq = executeFunction(ApplicationConstant.DB_TYPE_PIEPME, fo100)
					.toString();
			if (kq != null) {
				P300BEduPMG p300pmg = new P300BEduPMG();
				...
				if(json.has("FT110"))
					p300pmg.setFt110(json.getInt("FT110"));
				if(json.has("TV119"))
					p300pmg.setTv119(json.getString("TV119"));
