 ...
 * create Feb 24, 2017
 */
@Repository(value = SpringBeanNames.REPOSITORY_NAME_R100P)
@Scope("prototype")
public class R100PMGDaoImpl extends QbMongoDaoSupport implements R100PMGDao{
	@Override
	public List<R100PSta01> listOfTabR10001(int fo100, int fp300) {
		// TODO Auto-generated method stub
		try {
			setFunctionName(QbMongoFunctionNames.R100_LISTOFTABR100_01);
