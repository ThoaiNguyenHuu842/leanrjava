...
@Repository(value = SpringBeanNames.REPOSITORY_NAME_B920)
@Scope("prototype")
public class B920DaoImpl extends QbMySqlDaoSupport implements B920Dao {
	...
	public String chayGetelemTabB920(String ov101, String pvLogin) {
		...
		setQbSqlName(MySqlNames.BHAY_GETELEMTABB920);
		executeQbQuery();
