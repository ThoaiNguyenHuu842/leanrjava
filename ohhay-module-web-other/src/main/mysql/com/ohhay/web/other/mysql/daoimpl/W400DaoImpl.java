...
@Repository(value = SpringBeanNames.REPOSITORY_NAME_W400)
@Scope("prototype")
public class W400DaoImpl extends QbMySqlDaoSupport implements W400Dao {

	@Override
	public int inserttabw400(int pnPW400, String pvWV401, String ov1pvWV402, String pvWV403, String pvWV404, String pvWV405, int pnFO100, int pnFC800, int pnFH020, String pvLogin) {
		...
		setQbSqlName(MySqlNames.WHAY_INSERTTABW400);
		executeQbQuery();
