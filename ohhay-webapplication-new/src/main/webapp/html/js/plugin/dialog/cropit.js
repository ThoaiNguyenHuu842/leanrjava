...
(function($) {
    ...
    Cropit = function() {
        ...
        Cropit.prototype.rotate = function(degree) {
            ...
            exportOptions = $.extend({}, exportDefaults, degree);
            console.log('----BBB--CC--',exportOptions.type);

            rotateDegree = degree % 360;
            return this.loadImage(this.getRotatedDataURL(rotateDegree, exportOptions.type));
        };
        Cropit.prototype.getRotatedDataURL = function(degree, abc) {
...
(function($) {
    ...
    Cropit = function() {
        ...
        Cropit.prototype.getCroppedImageData = function(exportOptions) {
            ...
            console.log(this.image);
            console.log('exportOptions.type '  + exportOptions.type);
