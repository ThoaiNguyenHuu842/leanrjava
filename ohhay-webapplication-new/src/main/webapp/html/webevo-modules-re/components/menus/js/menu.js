	...
	omenu = {
		...
		open : function(option){
			...
			$('#qb-menu-option .menu-option-content .media-body').css({
				'background-color' : ob_component.css('background-color'),
				'background-image' : ob_component.css('background-image')
			});
		...
		addItem:function(){
			...
			var li_out = $('#qb-menu-option .menu-option-content  ul li a:first-child').attr('onmouseout');
