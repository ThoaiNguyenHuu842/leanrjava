...
//				optionList.goToEditMode();
		...
		save: function(){
            ...
            formData.append('editToolSelector', '.function-panel, .ui-resizable-handle, .menu-right, .qb-edit-tool, .ruler, .panel-no-eleme, .qb-spave-bottom-div, .evo-hair, .evo-grid-line, .qb-img-tool');
