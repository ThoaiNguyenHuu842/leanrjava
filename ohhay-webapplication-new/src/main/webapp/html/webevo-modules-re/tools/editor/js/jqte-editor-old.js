...
(function($){		
	$.fn.jqte = function(options){
		...
		//font-family
		/*var fontfamilys = ["Open Sans","Roboto-Regular","Arial","sans-serif","HelveticaNeue-Light","Aachen-Bold","Akronism","Antique","Architecture","Arrus-Black","Aztek","BigApple","Broad-Bold","BrushScript-BoldItalic","Circle","Circle3D","Crystal","Floral","FlowerDeco","Rockstone","Script-Italic","StarsStripes","UVNAnhHai","Windsor-Bold"];*/
		...
		return this.each(function(){
			...
			jQTE.find('.panel-group').append('<div class="panel setattr '+vars.css+'_fontform extendform" data-tool="fontform"><div class="panel-heading" role="tab" id="headingTwo">'
			...
			jQTE.find('.panel-group').append('<div class="panel setattr '+vars.css+'_iconform extendform" data-tool="iconform"><div class="panel-heading" role="tab" id="headingThree">'
			...
			jQTE.find('.panel-group').append('<div class="panel setattr '+vars.css+'_spacingform extendform" data-tool="spacingform"><div class="panel-heading" role="tab" id="headingFour">'
			...
			jQTE.find('.panel-group').append('<div class="panel setattr '+vars.css+'_shadowform extendform" data-tool="shadowform"><div class="panel-heading" role="tab" id="headingFive">'
			...
			jQTE.find('.panel-group').append('<div class="panel setattr '+vars.css+'_linkform extendform" data-tool="linkform"><div class="panel-heading" role="tab" id="headingSix">'
			...
			fontform.find('.panel-body').append('<div class="dropdown '+vars.css+'_fontstyle" unselectable></div><div class="dropdown '+vars.css+'_fontweight" unselectable></div><input class="'+vars.css+'_fontsize" type="number" min="0" value=""><span class="'+vars.css+'_fontcolor" data-val="#000000" style="background-color: #000000;"></span>');
			...
			spacingform.find('.panel-body').append('<label>Line height: <input class="'+vars.css+'_lheight" type="number" min="0" value=""></label><label>Character spacing: <input class="'+vars.css+'_space" type="number" min="0" value=""></label><label>Letter spacing: <input class="'+vars.css+'_letter" type="number" step="0.1" min="-3" value=""></label>');
			...
			shadowform.find('.panel-body').append('<div style="float:left;width:100%;"><p><img src="'+$("#contextPath").val()+'/html/images/shadow-h.png"/></p><p><img src="'+$("#contextPath").val()+'/html/images/shadow-v.png"/></p><p><img src="'+$("#contextPath").val()+'/html/images/shadow-blur.png"/></p></div>'
					+'<div style="float:left;width:100%;"><input class="'+vars.css+'_shadowH" type="number" value=""><input class="'+vars.css+'_shadowV" type="number" value=""><input class="'+vars.css+'_shadowBlur" type="number" min="0" value=""><span class="'+vars.css+'_shadowColor" data-val="#000000" style="background-color: #000000;"></span></div>');
...
//						thisElement.css("height",editor.outerHeight());
			...
			fontsize.bind("keypress keyup input",function(e){
			...
			lheight.bind("keypress keyup input",function(e){
			...
			space.bind("keypress keyup input",function(e){
				styleElement('space');
			});

			letter.bind("keypress keyup input",function(e){
				styleElement('letter');
			});
			
			shadowform.find('input').bind("keypress keyup input",function(e){
				styleElement('shadow');
			});
			...
			$(document).on("mouseup keyup",".otext-wrapper-content[contenteditable='true'], .grid-style-onedit .obutton-label[contenteditable='true']",function(){
				buttonEmphasize();
			});
