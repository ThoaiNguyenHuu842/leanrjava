	...
	webConfig = {
		...
		init : function() {
			...
			$("#qb-web-config #qb-slider-margin-left").slider({
			      ...
			      slide: function( event, ui ) {
			    	  $('#qb-web-config #qb-panel-web-config-lbl-value-margin-left').html(ui.value+"px");
			 ...
			 */
			$('#qb-web-config #qb-panel-web-config-lbl-value-margin-top').html(webConfig.data.mgT != -1?webConfig.data.mgT:0+ "px");
