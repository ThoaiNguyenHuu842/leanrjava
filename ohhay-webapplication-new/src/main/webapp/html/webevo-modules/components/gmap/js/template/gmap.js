function buildTemplateGmap(src) {
	...
	if(web.MV922==="ADMIN")
		template_single_gmap += 					'<li class="btnadmin-set-tolibrary"><a><i class="fa fa-bookmark-o"></i>Add to library</a></li>';
	...
	template_single_gmap += 					'<li class="btn-comp-copy"><a><i class="icon-display"></i>' + 'Copy (Ctrl + C)' + '</a></li>';
