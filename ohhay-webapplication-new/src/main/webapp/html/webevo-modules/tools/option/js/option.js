		...
		open : function(option){
			...
			try{
				...
				if(!shadow || shadow == "none"){
					...
					$('#cp-ot-shadow .option-shadow[data-type="type"] #ncg-option-shadow .content').html("outline ");
				}else{
					if(shadow.indexOf('inset') > -1)
						$('#cp-ot-shadow .option-shadow[data-type="type"] #ncg-option-shadow .content').html('inset ');
					else 
						$('#cp-ot-shadow .option-shadow[data-type="type"] #ncg-option-shadow .content').html("outline ");
...
//						});
			...
			$(document).on('click','.option-shadow .dropdown-menu li', function(e){
				var type = $(this).attr("value");
				$('.option-shadow #ncg-option-shadow .content').html($(this).html()+' ');
				$('.option-shadow[data-type="type"]').attr("value-type",type);
				cp_Option.shadowProcess(e);
			});
		...
		shadowProcess : function(e){
			...
			var val6 = $('.option-shadow[data-type="type"]').attr("value-type");
